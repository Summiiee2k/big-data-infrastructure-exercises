...
FILE_URL = (
    "https://raw.githubusercontent.com/martsec/flight_co2_analysis/main/data/aircraft_type_fuel_consumption_rates.json"
)
...
with DAG(
    ...
    def prepare_file(s3_key):
        ...
        s3_hook.load_string(csv_buffer.getvalue(), key=prepared_key, bucket_name=S3_BUCKET, replace=True)
    ...
    def load_to_postgres(prepared_data):
        ...
        pg_hook.bulk_load(table=POSTGRES_TABLE, tmp_file=csv_buffer, delimiter=",", is_tmp_file=False)
